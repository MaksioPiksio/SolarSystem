...
const movePlanetPosition = async (el: PlanetType, planetPosition: number) => {
    if (el[3]) {
...
const moveCameraPosition = async (
...
export { addPlanet, movePlanetPosition, moveCameraPosition };
